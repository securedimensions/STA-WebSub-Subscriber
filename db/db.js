...
const getSubscriptions = async function () {
    return new Promise((resolve, reject) => {
        ...
        for (let subscription of subscriptions) {
            subscription.topics = subscription.topics.split(',');
        }
...
const newSubscription = function(subscription) {
    return new Promise((resolve, reject) => {
        ...
        resolve(stmt.run(subscription.id, subscription.content_type, subscription.callback, subscription.topics.join(','), subscription.secret, subscription.lease_seconds, subscription.function, subscription.state));
    });
};
